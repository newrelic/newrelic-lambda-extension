...
func TestParseLambdaFaultLog(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "Standard Fault Log Without ErrorType",
			logLine: "RequestId: 456def Status: Error",
			want: &LambdaMetrics{
				RequestID: "456def",
				Error:     "Error",
				ErrorType: "",
		...
		{
			name:    "Fault Log With Custom Status",
			logLine: "RequestId: 789ghi Status: Throttled ErrorType: SomeType",
			want: &LambdaMetrics{
				RequestID: "789ghi",
				Error:     "Throttled",
				ErrorType: "SomeType",
		...
		{
			name:    "Fault Log With Status Only",
			logLine: "RequestId: 101xyz Status: Failed",
			want: &LambdaMetrics{
				RequestID: "101xyz",
				Error:     "Failed",
				ErrorType: "",
		...
		{
			name:    "Fault Log With Empty ErrorType",
			logLine: "RequestId: 202uvw Status: Error ErrorType: ",
			want: &LambdaMetrics{
				RequestID: "202uvw",
				Error:     "Error",
				ErrorType: "",
...
func TestParseLambdaReportLog(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			logLine: "RequestId: def456 Duration: 50.5 ms Billed Duration: 100 ms Memory Size: 256 MB Max Memory Used: 128 MB Init Duration: 250.00 ms",
			want: &LambdaMetrics{
				RequestID:      "def456",
				Duration:       50.5,
				BilledDuration: 100,
